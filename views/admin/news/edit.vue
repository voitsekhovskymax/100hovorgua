...
<template>
    <div id="add_news" class="page">
        ...
        <button @click="submit" style="margin:15px;" class="m_btn_blue_chevron">Оновити новину</button>
        <button @click="deletePost" style="margin:15px;" class="m_btn_cancel">Видалити новину</button>
    </div>
</template>
