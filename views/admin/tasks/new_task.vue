...
<template>
    <div id="customer_add_task" class="page">
        <div class="m_card_body">
            <div class="tf-wrap">
                <label for="">Оберіть замовника</label>
                <Select v-model="task.custom_author_id" size="large" placeholder="Оберіть замовника">
                    <Option v-for="user in users" v-if="user.is_approve == 1 && (user.role == 2 || user.role == 3)" :value="user.id" :key="user.id"> {{ user.first_name}} {{user.last_name
                        }}
                    </Option>
                </Select></div>
            ...
            <div class="tf-wrap">
                ...
                <RadioGroup v-model="task.type_task">
                    <Row :gutter="20" class="type_id">
                        ...
                        <Col :xs="24" :sm="12" :md="12" :lg="12">
                        <Radio label="2" class="command_task"><img src="/img/icons/comm.png"
                                                                   alt=""><span>Командне</span>
                        </Radio>
            ...
            <div class="tf-wrap">
                ...
                <Row :gutter="20" class="level_id">
                    <RadioGroup v-model="task.level_id">
                        ...
                        <Radio label="2"><img src="/img/icons/level1.png"
                                              alt=""><span>Легкий (бажання+присутність)</span>
                        </Radio>
        ...
        <modal name="new_task_success"
               ...
               :width="260"
        >
            <div class="new_task_success">
                <p>Дякуємо за співпрацю!</p>
                <p>Ваше завдання створено!</p>
