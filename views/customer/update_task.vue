...
<template>
    <div id="customer_add_task" class="page">
        <div class="container">
            <div class="title_page">Редагування завдання</div>
            <div class="m_card">
        ...
        <modal name="edit_task_success"
            ...
            <div class="new_task_success">
                ...
                <p>Оновлене завдання буде опубліковано на сайті після підтвердження менеджером</p>
                <router-link :to="{name:'customer_add_task'}" class="m_btn_orange_chevron">Створити ще завдання </router-link:>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                this.$modal.show('edit_task_success');
            },
